...
TECHNO_IMG = "https://telegra.ph/file/bb530eaebe85a412e646f.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def alain(bot: Bot, update: Update):
    ...
    update.effective_message.reply_text("📬*ʀᴇᴘᴏ ғᴏʀ ʙʟᴀᴄᴋ ʟᴇɢᴇɴᴅ ʙᴏᴛ ɪs* :- [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://t.me/ReDynamicUpdate)", parse_mode=ParseMode.MARKDOWN)
    update.effective_message.reply_text("📬*ʀᴇᴘᴏ ғᴏʀ ʙʟᴀᴄᴋ ʟᴇɢᴇɴᴅ ʙᴏᴛ ɪs* :- [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://t.me/ReDynamicUpdate)_", parse_mode=ParseMode.MARKDOWN)
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("ʜᴇʏᴀ, ᴄᴏɴᴛᴀᴄᴛ ᴍᴇ ɪɴ ᴘᴍ ᴛᴏ ɢᴇᴛ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴛʜᴇ ᴀᴠᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅs.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="❗ ᴄᴏɴᴛᴀᴄᴛ ᴛᴏ ᴍᴇ ʜᴇʟᴘ ❗",url="t.me/ReDynamicBot?start=help".format(bot.username))],
                                                [InlineKeyboardButton(text="🚀 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ 🚀",url="https://t.me/ReDynamicSupport")]]))
            ...
            msg.reply_text(text,
                           reply_markup=InlineKeyboardMarkup(
                               [[InlineKeyboardButton(text="🎛 ᴄʟɪᴄᴋ ᴛᴏ ɢᴇᴛ sᴇᴛᴛɪɴɢs 🎛",
                                                      url="t.me/ultroid_274732_bot?start=stngs_{}".format(
